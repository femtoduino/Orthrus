...
#define CONF_TC0_CMR_REG_VAL                                                                                           \
	(TC_CMR_TCCLKS(CONF_TC0_TCCLKS) | CONF_TC0_CLKI | TC_CMR_BURST(CONF_TC0_BURST) | TC_CMR_ETRGEDG(CONF_TC0_ETRGEDG)  \
	 | (CONF_TC0_ABETRG << TC_CMR_ABETRG_Pos)                                                                          \
	 | (((~CONF_TC0_EVENT_OUTPUT_WAVE) & CONF_TC0_CPCTRG) << 14)                                                       \
	 | ((CONF_TC0_EVENT_OUTPUT_WAVE << 15) & TC_CMR_WAVE)                                                              \
	 | (2 << 13) /* WAVSEL = 10 */                                                                                     \
	 | TC_CMR_WAVE)
#endif
